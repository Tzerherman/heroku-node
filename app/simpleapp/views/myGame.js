...
var scoreBoard;
var livesBoard;
var mainImages = ["Assets/Rubbish.png", "Assets/WashHair.png", "Assets/SavingShower.png", "Assets/DishWasher.png", "Assets/WaterCollection.png", "Assets/ThawFood.png",
"Assets/SwimmingPool.png", "Assets/Kettle.png", "Assets/WashCar.png", "Assets/WaterGarden.png", "Assets/WaterLeaks.png", "Assets/WaterMeter.png"];
var imgNo = 0;
...
function resetVariables() {
  myGamePiece = new component(60, 60, "Assets/WaterBucket.png", 265, 600, "image");
  waterDroplets = [];
}
...
function updateGameArea() {
    ...
    if(everyinterval(Math.round(100*myGameArea.timer*2))) {
      ...
      waterDroplets.push(new component(finalWeight, finalWeight, "Assets/WaterDropBad.png", x, -50, "death"));
      waterDroplets.push(new component(finalweight2, finalweight2, "Assets/WaterDropBad.png", x2, -500, "death"));
      waterDroplets.push(new component(finalweight2, finalweight2, "Assets/WaterDropBad.png", x2, -1000, "death"));
    }
    //if loop for creating the Lives Droplets
    if(everyinterval(500)){
      x = myGameArea.canvas.width*Math.random();
      waterDroplets.push(new component(40, 40, "Assets/WaterBucketLife.png", x, -120, "life"));
    }
    ...
    if (myGameArea.frameNo == 1 || everyinterval(Math.round(100*myGameArea.timer))) {
      ...
      waterDroplets.push(new component(finalWeight, finalWeight, "Assets/WaterDrop.png", x, -50, "score"));
      waterDroplets.push(new component(finalWeight2, finalWeight2, "Assets/WaterDrop.png", x2, -200, "score"));
      waterDroplets.push(new component(finalWeight3, finalWeight3, "Assets/WaterDrop.png", x3, -450, "score"));
    }
    for (i = 0; i < waterDroplets.length; i += 1) {
